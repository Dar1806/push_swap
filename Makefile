...
#    Updated: 2026/02/24 17:02:40 by nmeunier         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

LIBFT = libft/ft_putendl_fd.c libft/ft_putnbr_fd.c libft/ft_putstr_fd.c libft/ft_split.c \
...
SRCS = $(LIBFT) src/main.c src/verif.c
